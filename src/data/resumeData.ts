...
export const resumeData: ResumeData = {
  personalInfo: {
    ...
    summary:
      "Junior Full-Stack Developer with hands-on experience building web applications using React, Node.js, and databases. Passionate about learning, solving problems, and growing through real-world projects.",
  },
  about: {
    background:
      "I am a Junior Developer with a strong foundation in Information Technology and hands-on experience working at Four Point Zero. I have experience building and maintaining web applications, focusing on writing clean, maintainable, and practical code.",
    interests:
      "I am interested in Backend development and Full-Stack roles, and I enjoy learning how systems work end-to-end. I am motivated to continuously improve my skills, learn new technologies, and contribute to a collaborative engineering team.",
  },
  skills: [
    {
      title: "Frontend",
    ...
    {
      title: "Tools",
      items: [{ name: "Git & GitHub" }, { name: "Windows / macOS" }],
    },
  ],
  experience: [
    {
  ...
  projects: [
    {
      ...
      description:
        "A web application for job searching within KMITL. Helps students find part-time jobs to earn extra income and gain practical work experience.",
    },
    {
      title: "Planet Project (2022)",
      techStack: ["React", "Node.js (Express)"],
      description:
        "A to-do list web application featuring a donut chart that displays task completion percentage. Includes due dates and in-app notifications.",
    },
    {
      title: "IT Learn Project",
      techStack: ["React Native"],
      description:
        "A course management website with real-time chat and file attachment functionality.",
    },
    {
